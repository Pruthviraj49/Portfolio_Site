...
const Projects = () => {
    return (
        ...
        <motion.div class="grid grid-cols-1 justify-evenly items-center md:grid-cols-3 sm:grid-cols-2 gap-8 md:px-40 sm:px-16 px-10 " initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}>

            <motion.div className='bg-gray-100 dark:bg-gray-900 rounded-lg shadow-lg pt-10 font-chivoMono pb-20'>
                <motion.div className='px-10 sm:px-20 md:px-5' whileHover={{ scale: 1.1 }}>
                ...
                <div className="text-center justify-center pt-10 px-5 sm:px-12 md:px-5">
                    <motion.h2 className="text-base sm:text-lg md:text-xl font-bold cursor-pointer hover:underline mb-2" whileHover={{ scale: 1.1 }}>NewsMania (Flutter App)</motion.h2>
                    ...
                    <motion.div className="flex flex-wrap justify-center font-medium text-sm sm:text-base md:text-md text-gray-100 gap-3 mt-2 " whileHover={{ scale: 1.05 }}>
            ...
            <motion.div className='bg-gray-100 dark:bg-gray-900 rounded-lg shadow-lg pt-10 font-chivoMono pb-20'>
                ...
                <div className="text-center justify-center pt-10 px-5 sm:px-12 md:px-5">
                    <motion.h2 className="text-base sm:text-lg md:text-xl font-bold cursor-pointer hover:underline mb-2" whileHover={{ scale: 1.1 }}>NoteTake (Flutter App)</motion.h2>
            ...
            >
                <motion.div className='px-10 sm:px-20 md:px-5' whileHover={{ scale: 1.05 }}>
                    <Image
                ...
                <div className='text-center justify-center pt-10 px-5 sm:px-12 md:px-5'>
                    ...
                    <motion.div
                        className='flex flex-wrap justify-center font-medium text-sm sm:text-base md:text-md text-gray-100 gap-3 mt-2 '
